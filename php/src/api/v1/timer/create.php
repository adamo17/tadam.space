...
$created_at = date('m/d/Y G:i:s', time());
...
query(sprintf("INSERT INTO timers (name, description, tags, project, elapsed, created_at, owner) 
    VALUES ('%s', '%s', '%s', '%s', '%s', '%s', %s)",
    $name, $description, $tags, $project, "00:00:00", $created_at, $user_id));
