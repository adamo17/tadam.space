...
$email = b64url_decode($auth["email"]);

$code = str_pad(rand(0, pow(10, 6) - 1), 6, '0', STR_PAD_LEFT);
$mlt = generateRandomString(32);

$valid_until = time() + 60 * 5;

query(
    sprintf(
        "INSERT INTO verification_codes (code, valid_until, magic_link_token, user_id) VALUES ('%s', %s, '%s', %s)",
        "ts_".$code,
        $valid_until,
        $mlt,
        $auth["id"]
...
$mail->Host = 'smtp.websupport.sk'; // Specify main SMTP server
$mail->SMTPAuth = true; // Enable SMTP authentication
$mail->Username = 'noreply@tadam.space'; // SMTP username
$mail->Password = 'Adamko.09'; // SMTP password
$mail->SMTPSecure = 'tls'; // Enable TLS encryption, 'ssl' also accepted
$mail->Port = 587; // TCP port to connect to
$mail->setFrom('noreply@tadam.space', 'TSpace');
$mail->addAddress($email);
$mail->isHTML(true);
$mail->Subject = "[TSpace] Verify Your Account";
$mail->Body = "Hello " . b64url_decode($auth["user"]) .
    "!<br/><br/>Thank you for registering!<br/>To use our website, you need to verify.<br/>Your code is: <b>" .
    $code .
    "</b><br/>Alternatively you can click here: <a href='https://tadam.space/api/v1/user/magic_link.php?code="
    . $code . "&token=" . $mlt . "'>Verify</a><br/>This code is valid for 5 minutes.";
$mail->AltBody = "Hello " . b64url_decode($auth["user"]) .
    "!\n\nThank you for registering!\nTo use our website, you need to verify.\nYour code is: " . $code .
    "\nAlternatively you can use this link: https://tadam.space/api/v1/user/magic_link.php?code="
